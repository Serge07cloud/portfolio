            ...
            <div className="mt-10 grid max-w-2xl mx-auto justify-items-center grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              <article className="max-w-sm bg-white border border-gray-200 rounded shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                  ...
                  <p className="font-normal text-gray-700 dark:text-gray-400">
                    Administrative web platform for managing multiple websites
                    content and meta data information.
                  </p>
                  ...
                  <a
                    href="https://intraversalis.webversalis.net"
              ...
              <article className="max-w-sm bg-white border border-gray-200 rounded shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                  ...
                  <p className="font-normal text-gray-700 dark:text-gray-400">
                    A web application featuring puzzle games built from images
                    of famous places in Switzerland.
                  </p>
                  <div className="flex justify-evenly items-center py-3">
                  ...
                  <a
                    href="https://puzzle-helvetica.webversalis.net"
                    className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Live demo
                    <svg
              ...
              <article className="max-w-sm bg-white border border-gray-200 rounded shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1759049219585-4feb729fb018?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1278"
                    alt=""
                  />
                </a>
                <div className="p-5">
                  ...
                  <p className="font-normal text-gray-700 dark:text-gray-400">
                    Modeled, and deployed a joke API with voting features,
                    categories, and token authentication.
                  </p>
                  <div className="flex justify-evenly items-center py-3">
